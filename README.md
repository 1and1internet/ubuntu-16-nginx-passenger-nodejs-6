# ubuntu-16-nginx-passenger-nodejs-4

A Docker image to use as a basis for Nodejs 4 based web applications running under Phusion Passenger and nginx. Intended for eventual deployment under OpenShift.
