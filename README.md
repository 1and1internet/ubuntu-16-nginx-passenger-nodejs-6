# ubuntu-16-nginx-passenger-nodejs-6

A Docker image to use as a basis for Nodejs 6 based web applications running under Phusion Passenger and nginx. Intended for eventual deployment under OpenShift.
